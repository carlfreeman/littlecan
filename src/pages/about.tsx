      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center gap-6 mt-8">
            ...
            <a 
              href="mailto:marco.litvak@yandex.ru"
              className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24">
                <path 
        ...
        <div className="prose prose-invert text-justify max-w-none space-y-4">
          <p>
            Я Марк Литвак, скрипач, композитор и фотограф по воле судьбы. Снимаю город, друзей и вещи, мимо которых обычно проходят: трещины в асфальте, смятые билеты, тени на стенах. 
            ...
            Когда я иду по городу с камерой, я ищу не просто интересные объекты - я ищу моменты, которые раскрывают что-то более глубокое о человеческом состоянии и окружающих вещах.
          </p>
          <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              <ul className="space-y-2">
                ...
                <li>Вечная сила и красота природы</li>
              </ul>
            </div>
